...
Below is a real-world example of a component in development. It's over 350 lines of code, and over 200 of those are in the render-method. Let's see what we can do to make this a little simpler to work with.
...
@Component({
    tag: 'lwc-solution-change-business-status',
    shadow: true,
    styleUrl: 'lwc-solution-change-business-status.scss',
})
export class ChangeBusinessStatus implements LimeWebComponent {
    @Prop()
