...
Read more about the difference between Solutions and Packages at [Lime CRM Platform Documentation](https://lime-crm-platform.readthedocs-hosted.com/en/latest/packages-intro/limepackages.html)
